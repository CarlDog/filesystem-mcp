...
6. Verify health: `curl http://carldog-nas:3006/health`.
...
claude mcp add --transport http --scope user filesystem http://carldog-nas:3006/mcp
```
...
"filesystem": {
  "command": "npx",
  "args": ["-y", "mcp-remote", "http://carldog-nas:3006/mcp", "--allow-http"]
}
```
